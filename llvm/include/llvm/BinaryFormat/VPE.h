...
//===----------------------------------------------------------------------===//
//
// This file contains an definitions used in VPE Files.
//
...
#ifndef LLVM_BINARYFORMAT_VPE_H
#define LLVM_BINARYFORMAT_VPE_H
...
// The maximum number of sections that a VPE object can have (inclusive).
const int32_t MaxNumberOfSections16 = 65279;

// The VPE signature bytes that follows the DOS stub header.
static const char PEMagic[] = {'V', 'P', 'E', '\0'};
...
// Sizes in bytes of various things in the VPE format.
enum {
  Header16Size = 20,
  Header32Size = 56,
  NameSize = 8,
...
enum Characteristics : unsigned {
  ...
  /// VPE line numbers have been stripped. This is deprecated and should be
  /// 0.
  IMAGE_FILE_LINE_NUMS_STRIPPED = 0x0004,
  /// VPE symbol table entries for local symbols have been removed. This is
...
struct PE32Header {
  enum { VPE32 = 0x10b, VPE32_PLUS = 0x20b };
...
enum Subsystem : unsigned {
  ...
  IMAGE_SUBSYSTEM_MODULE = 1,  ///< Device drivers and native Windows processes
  IMAGE_SUBSYSTEM_SERVICE = 2,  ///< Device drivers and native Windows processes
  IMAGE_SUBSYSTEM_APPLICATION = 3,  ///< Device drivers and native Windows processes
  IMAGE_SUBSYSTEM_EFI_APPLICATION = 4, ///< An EFI application.
  IMAGE_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER = 5, ///< An EFI driver with boot
                                                ///  services.
  IMAGE_SUBSYSTEM_EFI_RUNTIME_DRIVER = 6,      ///< An EFI driver with run-time
                                                ///  services.
  IMAGE_SUBSYSTEM_EFI_ROM = 7,                 ///< An EFI ROM image.
};
