...
#if defined(__LP64__) || defined(__VALI64__) || defined(_WIN64) || defined(_LIBCXXABI_ARM_EHABI)
...
#if !defined(__LP64__) && !defined(_WIN64) && !defined(__VALI64__) && !defined(_LIBCXXABI_ARM_EHABI)
    // This is a new field to support C++11 exception_ptr.
...
static_assert(offsetof(__cxa_dependent_exception, propagationCount) +
                  ...
                  sizeof(__cxa_dependent_exception),
              "propagationCount has wrong negative offset");
#elif defined(__LP64__) || defined(__VALI64__) || defined(_WIN64)
