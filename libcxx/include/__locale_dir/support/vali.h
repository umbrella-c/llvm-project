...
#ifndef _LIBCPP___LOCALE_DIR_SUPPORT_VALI_H
#define _LIBCPP___LOCALE_DIR_SUPPORT_VALI_H
...
inline _LIBCPP_HIDE_FROM_ABI const char* __get_locale_encoding(__locale_t __loc) {
  return ::__locale_encoding_l(__loc);
}
...
#endif // _LIBCPP___LOCALE_DIR_SUPPORT_VALI_H
